...
import { Route as pimiaRouteImport } from "./routes/pimia";
...
const pimiaRoute = pimiaRouteImport.update({
  id: "/pimia",
  path: "/pimia",
  getParentRoute: () => rootRouteImport,
} as any);
...
const pimiaDotpresupuestosDotestimateIdRoute =
...
declare module "@tanstack/react-router" {
  interface FileRoutesByPath {
    ...
    "/pimia": {
      ...
      path: "/pimia";
      fullPath: "/pimia";
      preLoaderRoute: typeof pimiaRouteImport;
      parentRoute: typeof rootRouteImport;
    };
    "/agents": {
      id: "/agents";
